  ...
  return (
    <>
      ...
      <div className="footer flex-center">
        <h5>
          Made with ❤️ by <a href="https://www.linkedin.com/in/sambitsargam/" target="_blank" rel="noreferrer">Sambit Sargam Ekalabya</a>{" "}
        </h5>
        <p className="paragraph-sm">www.nist.edu © 2023</p>
      </div>
    </>
  );
}
